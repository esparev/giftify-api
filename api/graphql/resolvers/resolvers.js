...
const { gift, gifts, giftsByCategory, giftsBySearchInput, addToCart, createGift, updateGift, deleteGift } = require('./gift.resolvers'); // prettier-ignore
...
const resolvers = {
    ...
    addToCart, createGift, addToCart, updateGift, deleteGift,
